...
NB. data=: (readcsv 'C:\Users\vincentt51822\Desktop\ashar-bundle\clinical_outcomes.csv')
...
data_groups=: subset group_by <"1 (;"1 (data column 'group'),.(data column 'redcap_event_name'))

group_avgs=: ungroup subj_summary summarize data_groups
...
groups=. (1,2,3)
pd 'reset'
pd 'key PRT Saline SOC'
pd 'keycolor RED, GREEN, BLUE'
pd 'title CLBP intensity after interventions'
pd 'xcaption months'
pd 'ycaption BPI_Intensity'
(plot_one_group~&data_set)"0 groups
pd 'show'
)

make_plot group_avgs_f